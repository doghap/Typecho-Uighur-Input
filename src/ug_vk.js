...
var UG_VK_OPTS = {
        all:  true,
        blacklist: [
            'password', 'name', 'url', 'mail', 'confirm',
            'logoUrl', 'content', 'fieldNames[]', 'fieldValues[]', 'order', 'slug', 'siteUrl', 'attachmentTypesOther',
            'commentDateFormat', 'commentsListSize', 'commentsHTMLTagAllowed', 'postDateFormat', 'postsListSize', 'pageSize',
            'database', 'host', 'port', 'user', 'prefix'
        ]
    };
